        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="race_name">Event/Race Name (Optional)</Label>
                <Input
                  id="race_name"
                  name="race_name"
                  placeholder="e.g., Boston Marathon, Local 5K, etc."
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="goal_pace_per_km">Goal Pace (min/km)</Label>
                <Input
                  id="goal_pace_per_km"
                  name="goal_pace_per_km"
                  placeholder="e.g., 5:30, 4:45"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label htmlFor="current_weekly_mileage">Current Weekly Km</Label>
                <Input
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleSelectChange('elevation_context', value)} value={formData.elevation_context}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="trail">Trail/Mountain</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="strength_notes">Strength Training Experience</Label>
              <Textarea
                id="strength_notes"
                name="strength_notes"
                placeholder="Describe your current strength training routine, gym access, preferred exercises"
