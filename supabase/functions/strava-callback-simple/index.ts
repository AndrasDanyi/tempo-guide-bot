...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Strava callback received:', { code: !!code, state: !!state, error });
    ...
    // Redirect back to Vercel app with success
    return Response.redirect('https://tempo-guide-bot.vercel.app/?strava=connected', 302);

  } catch (error) {
    console.error('Error in strava-callback-simple function:', error);
